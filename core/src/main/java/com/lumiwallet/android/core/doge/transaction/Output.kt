...
internal class Output(
    ...
    override fun toString(): String = "$destination $satoshi"
    ...
    private fun validateDestinationAddress(destination: String) {
        ...
        require(Base58.decodeChecked(destination)[0] == DogeNetParams.addressHeader.toByte()) { ErrorMessages.OUTPUT_ADDRESS_WRONG_PREFIX }
    }
