...
interface BtcSigningView : BaseMvpView {
    fun notifyDataChanges()
    fun setData(data: MutableList<BtcTxAdapter.ViewItem>)
    fun setupView()
...
class BtcSigningFragment : BaseFragment(),
    BtcSigningView {

    @InjectPresenter
    lateinit var presenter: BtcSigningPresenter

    private val adapter: BtcTxAdapter =
        BtcTxAdapter(
    ...
    override fun setData(data: MutableList<BtcTxAdapter.ViewItem>) {
