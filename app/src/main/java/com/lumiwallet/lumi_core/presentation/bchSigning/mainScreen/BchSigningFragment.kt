...
interface BchSigningView : BaseMvpView {
    fun notifyDataChanges()
    fun setData(data: MutableList<BchTxAdapter.ViewItem>)
    fun setupView()
...
class BchSigningFragment : BaseFragment(),
    BchSigningView {

    @InjectPresenter
    lateinit var presenter: BchSigningPresenter

    private val adapter: BchTxAdapter =
        BchTxAdapter(
    ...
    override fun setData(data: MutableList<BchTxAdapter.ViewItem>) {
